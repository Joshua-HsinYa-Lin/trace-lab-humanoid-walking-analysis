...
data_grf = readtable('data_csv/grf_data_single.csv');
data_leg_R = readtable('data_csv/single_joint_data_right.csv');
data_leg_L = readtable('data_csv/single_joint_data_left.csv');
time = data_grf.Time;

fig1 = figure('Color', 'w', 'Name', 'Lateral Symmetry Check', 'Position', [100 100 1000 700]);
